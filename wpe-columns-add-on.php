<?php
/**
 * Plugin Name: WP Editor Columns Add-on
 * Plugin URI: http://wp-editor.com/
 * Description: Power Up WordPress Visual Editor With Columns
 * Version: 0.1.1
...
class WPE_Addon_Columns{
	...
	public function updater_setup(){
		...
		$config = array(
			...
			'repo_slug' => 'wpe-columns-add-on',  //required
		);

		/* Load Updater Class */
		new WPE_Columns_Plugin_Updater( $config );
	}
}

new WPE_Addon_Columns();
